...
export default async function CustomerLoansInProcessPage({
  params,
  searchParams,
}: {
  ...
  return (
    <section className="space-y-4">
      ...
      <Suspense
        key={`loans-in-process-${currentPage}-${pageSize}`}
        fallback={<SpinnerLoader label="Cargando prestamos en proceso..." />}
      >
        <LoansTable
          customerId={userId}
          status="IN_PROCESS"
